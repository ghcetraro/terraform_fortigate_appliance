...
- API token de FortiGate en `terraform.tfvars`: nunca commitear
- Los cambios se aplican directamente al firewall: revisar `terraform plan`

## Reporte de vulnerabilidades

Si encontrás un problema de seguridad, abrí un [GitHub Security Advisory](https://github.com/ghcetraro/terraform_fortigate_appliance/security/advisories/new) o contactá al mantenedor del repo. No abras issues públicos con detalles explotables.
